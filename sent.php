<!doctype html>
                        <html>
                            <head>
                                ...
                                <link href='css/stly.css' rel='stylesheet'>
...
@media only screen and (max-width: 800px) {
    ...
    <div class="custom-modal" style="background: #310a08;">
        <div class="danger danger-animation icon-top"><i class="fa fa-times"></i></div>
        <div class="danger border-bottom"></div>
        <div class="content">
            <p class="type">Oops</p>
            <p class="message-type" style="color: #dbc5c4;">Somthing went wrong <br> please try again</p>
        </div>
    </div>
</div>
<script>
